...
<table width="100%" style="margin-bottom: 5em;">
	<tr class="text-center">
		<td style="background-color: #8FAADC;font-size: 25px;font-weight: bold;padding: .5em;border: solid 1px black;">DOCUMENT REFRENCE NUMBER</td>
	</tr>
</table>
<table width="100%">
	<tr >
...
<p style="font-size: 25px;">Thank you for choosing DTI EOTC-PHP!</p>
</body>
</html>
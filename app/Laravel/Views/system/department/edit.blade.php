...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="{{route('system.department.index')}}">Deparment Management</a></li>
...
<div class="col-md-8 grid-margin stretch-card">
  <div class="card">
    <div class="card-body">
      <h4 class="card-title">Deparment Edit Form</h4>
      ...
      <form class="create-form" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control {{$errors->first('name') ? 'is-invalid' : NULL}}" id="input_title" name="name" placeholder="Department/Agency Name" value="{{old('name',$department->name)}}">

     ...
     <form>
      <div class="row pb-2">
        ...
        <div class="col-md-4">
          ...
          {!!Form::select("application_status", $status, $selected_application_status, ['id' => "input_processing_fee_status", 'class' => "custom-select"])!!}
        </div>
      ...
      <div class="row">
        ...
        <div class="col-md-4 p-2">
          ...
          <a href="{{route('system.transaction.approved')}}" class="btn btn-primary btn-sm p-2">Clear</a>
        </div>
      </div>
    </form>
  </div>
